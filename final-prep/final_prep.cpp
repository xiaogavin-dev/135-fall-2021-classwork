...
2.2: Define a recursive function that takes a string, return its reversed version. For example, if the input is “abc”, the return is “cba”. Define function header. Suppose the function name is reverse, the given parameter is called str.
...
2.3: Define a function foo, for a given array arr of ints and its size, return type is empty. Define the function header.
