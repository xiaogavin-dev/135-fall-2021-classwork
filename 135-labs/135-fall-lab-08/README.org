...
* Notes: 
- Edited .pgm files are named under task ~Letter~ -image ~Number~ .pgm ex. taskA-image1.pgm
- ~Number~ goes from 1-3, and ~Letter~ goes from A-F. Case sensitive
- Has ~make remove-images~ to remove edited .pgm images 
